...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPlaintextEditor : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetWordCount(PRUint32 *_retval) = 0;

  /* unsigned long getSelectionWordCount (in nsISelection aSelection); */
  NS_SCRIPTABLE NS_IMETHOD GetSelectionWordCount(nsISelection *aSelection, PRUint32 *_retval) = 0;
...
#define NS_DECL_NSIPLAINTEXTEDITOR \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetWordCount(PRUint32 *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetSelectionWordCount(nsISelection *aSelection, PRUint32 *_retval); 
...
#define NS_FORWARD_NSIPLAINTEXTEDITOR(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetWordCount(PRUint32 *_retval) { return _to GetWordCount(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetSelectionWordCount(nsISelection *aSelection, PRUint32 *_retval) { return _to GetSelectionWordCount(aSelection, _retval); } 
...
#define NS_FORWARD_SAFE_NSIPLAINTEXTEDITOR(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetWordCount(PRUint32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetWordCount(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetSelectionWordCount(nsISelection *aSelection, PRUint32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSelectionWordCount(aSelection, _retval); } 
...
/* unsigned long getSelectionWordCount (in nsISelection aSelection); */
NS_IMETHODIMP nsPlaintextEditor::GetSelectionWordCount(nsISelection *aSelection, PRUint32 *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
