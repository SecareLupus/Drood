...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAutoCompleteStatus {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IAUTOCOMPLETESTATUS_IID)
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(nsIAutoCompleteStatus, NS_IAUTOCOMPLETESTATUS_IID)
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAutoCompleteListener : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IAUTOCOMPLETELISTENER_IID)

  /* void onStatus (in wstring statusText); */
  NS_SCRIPTABLE NS_IMETHOD OnStatus(const PRUnichar *statusText) = 0;

  /* void onAutoComplete (in nsIAutoCompleteResults result, in AutoCompleteStatus status); */
  NS_SCRIPTABLE NS_IMETHOD OnAutoComplete(nsIAutoCompleteResults *result, AutoCompleteStatus status) = 0;
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(nsIAutoCompleteListener, NS_IAUTOCOMPLETELISTENER_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIAUTOCOMPLETELISTENER \
  NS_SCRIPTABLE NS_IMETHOD OnStatus(const PRUnichar *statusText); \
  NS_SCRIPTABLE NS_IMETHOD OnAutoComplete(nsIAutoCompleteResults *result, AutoCompleteStatus status); \
...
#define NS_FORWARD_NSIAUTOCOMPLETELISTENER(_to) \
  NS_SCRIPTABLE NS_IMETHOD OnStatus(const PRUnichar *statusText) { return _to OnStatus(statusText); } \
  NS_SCRIPTABLE NS_IMETHOD OnAutoComplete(nsIAutoCompleteResults *result, AutoCompleteStatus status) { return _to OnAutoComplete(result, status); } \
...
#define NS_FORWARD_SAFE_NSIAUTOCOMPLETELISTENER(_to) \
  NS_SCRIPTABLE NS_IMETHOD OnStatus(const PRUnichar *statusText) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnStatus(statusText); } \
  NS_SCRIPTABLE NS_IMETHOD OnAutoComplete(nsIAutoCompleteResults *result, AutoCompleteStatus status) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnAutoComplete(result, status); } \
