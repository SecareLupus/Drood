...
function DroodLogService () {
}

DroodLogService.prototype = {
  QueryInterface: function (aIID) {
    if (aIID.equals(Ci.nsISupports) ||
        aIID.equals(Ci.nsIObserver) ||
        aIID.equals(Ci.droodILogService))
      return this;
  ...
  openNamedLog: function openNamedLog (aName) {
    if (! (aName in this.logs))
      this.logs[aName] = new DroodLogger(aName);
...
DroodLogger.prototype = {
  QueryInterface: function (aIID) {
    if (aIID.equals(Ci.nsISupports) ||
        aIID.equals(Ci.droodILogger))
      return this;
...
var initModule = {
  ...
  ServiceContractID: "@drood.com/log-service;1",
  ServiceName: "Drood Log Service",
  ...
  registerSelf: function (compMgr, fileSpec, location, type) {
    ...
    catman.addCategoryEntry("app-startup", "Drood Log Service",
  ...
  instanceFactory: {
    createInstance: function (outer, iid) {
      ...
      return new DroodLogService().QueryInterface(iid);
    }
  }
};
