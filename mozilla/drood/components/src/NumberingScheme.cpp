...
NumberingScheme::Init (nsIRDFDataSource* aDS, nsIRDFResource* aResource)
{
  ...
  rdfsvc->GetDataSourceBlocking("chrome://drood/content/schema.rdf",
  ...
  rdfsvc->GetResource(NS_LITERAL_CSTRING("http://drood.com/NS/v1/position"),
    getter_AddRefs(posarc));
  rdfsvc->GetResource(NS_LITERAL_CSTRING("http://drood.com/NS/v1/numbering"),
    getter_AddRefs(numarc));
  rdfsvc->GetResource(NS_LITERAL_CSTRING("http://drood.com/NS/v1/prefix"),
    getter_AddRefs(prearc));
  rdfsvc->GetResource(NS_LITERAL_CSTRING("http://drood.com/NS/v1/suffix"),
