...
NS_IMETHODIMP nsScriptScene::Init (nsIRDFDataSource* ds,
  ...
  rdfsvc->GetResource(NS_LITERAL_CSTRING("http://drood.com/NS/v1/members"),
    getter_AddRefs(membersarc));

  nsCOMPtr<nsIRDFResource> markuparc;
  rdfsvc->GetResource(NS_LITERAL_CSTRING("http://drood.com/NS/v1/markup"),
...
NS_IMETHODIMP nsScriptScene::ExtractBreakdownInRange (nsIDOMRange* range, nsIScriptMarkupValidator* validator) {
  ...
  rdfsvc->GetResource(NS_LITERAL_CSTRING("http://drood.com/NS/v1/Cast"),
  ...
  nsCOMPtr<droodINodeIterator> iter(
    do_CreateInstance("@drood.com/dom/iterator;1"));
  if (! iter)
...
NS_IMETHODIMP nsScriptScene::GetDeptSequence (nsIRDFResource* deptres,
  ...
  rdfsvc->GetResource(
    NS_LITERAL_CSTRING("http://drood.com/NS/v1/DepartmentList"),
    getter_AddRefs(deptlisttype));

  nsCOMPtr<nsIRDFResource> deptarc;
  rdfsvc->GetResource(
    NS_LITERAL_CSTRING("http://drood.com/NS/v1/department"),
...
NS_IMETHODIMP nsScriptScene::UpdateSeqSize (nsIRDFContainer* seq) {
  ...
  rdfsvc->GetResource(NS_LITERAL_CSTRING("http://drood.com/NS/v1/size"),
