...
function openObjectsLink () {
  top.gApp.openBrowser("http://www.drood.com/toolbox.html");
}
...
ShotEditor.prototype = {
  ...
  open: function (project, docres) {
    ...
    } catch (ex) { droodBugAlert(ex, Components.stack, ex); }
  ...
  save: function () {
    ...
    obsvc.notifyObservers(this.docres, "drood:shot-document-saved", null);
  ...
  loadPalettes: function () {
    ...
    var catres = rdfsvc.GetResource("urn:drood:categories");
  ...
  loadPalette: function (palette) {
    ...
    var categoryseq = rdfsvc.GetResource("urn:drood:categories");
  ...
  populatePalettes: function () {
    ...
    var defaulticon = "chrome://drood/skin/documents/misc.png";
    ...
    var categories = rdfsvc.GetResource("urn:drood:categories");
    ...
    for (var i = 0; i < categories.length; ++i) {
      ...
      cell.setAttribute("src", "chrome://drood/skin/folder.png");
