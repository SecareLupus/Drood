...
var gPDFController = {
  ...
  loaded: function loaded () {
    ...
    /*
    try {
      var ps = getPrefService().getBranch("drood.pdf.");
  ...
  cmdGeneratePreview: function cmdGeneratePreview () {
    ...
    // The upload channel
    var previewURL = getDroodService().PDF_PREVIEW_URL;
    // if (gScriptController.mode == "av")
    //   previewURL += "av";
  ...
  exportScriptAsPDF: function exportScriptAsPDF (file) {
    ...
    try {
      ...
      // The upload channel
      var convertURL = getDroodService().PDF_CONVERT_URL;
      // if (gScriptController.mode == "av")
      //   convertURL += "av";
...
function prefilterForPDF (doc) {
  try {
    ...
    var branch = getPrefService().getBranch('drood.pdf.');
