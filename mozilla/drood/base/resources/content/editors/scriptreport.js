...
var gReportController = {
  ...
  kScenesURL: "http://drood.com/selection/scenes",
  kDeptsURL: "http://drood.com/selection/departments",
  kItemsURL: "http://drood.com/selection/items",
  ...
  generateDataCallback: function generateDataCallback () {
    ...
    var allScene = rdfsvc.GetResource("urn:drood:scene:all");
    ...
    var ps = getPrefService().getBranch("drood.scripteditor." + mode + ".");
  ...
  createBogusAllDS: function createBogusAllDS () {
    ...
    // The magical "ALL" scene
    var allScene = svc.GetResource("urn:drood:scene:all");
    ...
    var allDept = svc.GetResource("urn:drood:department:all");
