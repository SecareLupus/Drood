...
BreakdownSidebarController.prototype = {
  QueryInterface: function (aIID) {
    if (aIID.equals(Components.interfaces.nsISupports) ||
        ...
        aIID.equals(Components.interfaces.droodISidebar))
      return this;
  ...
  toggleAddItemBox: function () {
    ...
    if (addItemBox.collapsed) {
      toggleAddButton.image = "chrome://drood/skin/arrow_down.gif";
      addItemBox.collapsed = false;
      nameBox.focus();
    }
    else {
      toggleAddButton.image = "chrome://drood/skin/arrow_right.gif";
