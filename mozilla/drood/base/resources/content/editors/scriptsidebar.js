...
var gPanel = {
  ...
  showAddBox: function showAddBox () {
    ...
    button.image = "chrome://drood/skin/arrow_down.gif";
    var box = document.getElementById("sidebaradditembox");
    box.collapsed = false;
  ...
  hideAddBox: function hideAddBox () {
    var button = document.getElementById("sidebaraddbutton");
    button.image = "chrome://drood/skin/arrow_right.gif";
    var box = document.getElementById("sidebaradditembox");
    box.collapsed = true;
  },
  ...
  observe: function (aSubject, aTopic, aData) {
    ...
    if (aSubject == "drood:script:will-change-lock") {
      if (aData == "locked") {
        this.controller.editor.editor.removeEditActionListener(this);
      }
    }
    else if (aSubject == "drood:script:did-change-lock") {
      if (aData == "unlocked") {
  ...
  shutdown: function () {
    var obs = getObserverService();
    obs.removeObserver(this, "drood:script:will-change-lock");
    obs.removeObserver(this, "drood:script:did-change-lock");
  ...
  changeSidebar: function changeSidebar (view) {
    ...
    var sidebarbtn = document.getElementById("drood-sidebar-button");
  ...
  toggleSidebar: function toggleSidebar () {
    ...
    document.getElementById("drood-sidebar-button").checked = ! collapsed;
  },
  ...
  extractBreakdown: function (scene) {
    ...
    var scriptscene = Components.classes["@drood.com/scriptscene;1"]
