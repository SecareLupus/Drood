...
var gCardController = {
  ...
  /*
   * In Drood 2.7 and earlier, tagnames was a map of symbolic colour names to
  ...
  loaded: function loaded () {
    ...
    var ps = getPrefService().getBranch("drood.tag.");
  ...
  setTagName: function (aColour, aName) {
    ...
    obsvc.notifyObservers(this, "drood:scenecards:tagchanged", null);
  },
  ...
  onClick: function onClick (element) {
    ...
    var ps = getPrefService().getBranch("drood.scenecards.");
