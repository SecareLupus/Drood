...
var gController = {
  ...
  observe: function (aSubject, aTopic, aData) {
    ...
    else if (topic == "drood:project-saved" && ! this.project.standalone) {
      hideScriptOnlyMessage();
      getObserverService().removeObserver(this, "drood:project-saved");
  ...
  scriptLoaded: function (aEvent) {
    ...
    if (this.project.standalone && this.project.scriptURI == this.docres.Value) {
      ...
      getObserverService().addObserver(this, "drood:project-saved", false);
  ...
  saveZoomLevel: function () {
    ...
    var prefs = getPrefService().getBranch("drood.texteditor.");
...
function showScriptOnlyFAQ () {
  top.gApp.openBrowser("https://www.drood.com/faq.html#scriptOnly");
}
