...
function loaded () {
  ...
  gDialog.numberSvc = Components.classes["@drood.com/scene-number-service;1"]
...
function createItemForScene (scene) {
  ...
  leftbumper.setAttribute("image",
    "chrome://drood/skin/triangle_left.png");
  ...
  rightbumper.setAttribute("image",
    "chrome://drood/skin/triangle_right.png");
...
function toggleDetails () {
  ...
  if (grid.collapsed) {
    ...
    icon.src = "chrome://drood/skin/arrow_down.gif";
  }
  else {
    grid.collapsed = true;
    icon.src = "chrome://drood/skin/arrow_right.gif";
  }
...
function setDroodPreset () {
  setScheme(gDialog.preset.drood);
  lockFields();
}
