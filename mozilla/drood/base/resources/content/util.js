...
function getDroodService () {
  return Components.classes["@drood.com/drood-service;1"]
    .getService(Components.interfaces.nsIDroodService);
}


function getMediaManager () {
  return Components.classes["@drood.com/media-manager;1"]
    .getService(Components.interfaces.droodIMediaManager);
}
...
function setDroodProjectsDir (dir) {
  var ps = getPrefService().getBranch("drood.directory.");
...
// Returns the Drood temporary directory as an nsIFile
function getTempDir () {
  var cxsvc = Components.classes["@drood.com/drood-service;1"]
    .getService(Components.interfaces.nsIDroodService);
...
function sanitizeUTF8File (file) {
  ...
  var stripper = Components.classes["@drood.com/control-char-stripper;1"]
...
function droodBugAlert (msg, stack, ex, header) {
  if (! stack)
    stack = Components.stack.caller;
  window.openDialog(Cx.CONTENT_PATH + "drooderror.xul", "_blank",
...
var Cx = {
  ...
  get PREFS_FILE    () { return 'drood_prefs.rdf' },
  get PROJECTS_FILE () { return 'drood.rdf' },
  get PROJECTS_DIR  () { return 'drood.d' },
  get TEMPLATES_DIR () { return 'DroodTemplates' },
  get SAMPLES_DIR   () { return 'DroodSamples' },
  get PROJECT_FILE  () { return 'project.rdf' },
  get LOCAL_DS_FILE () { return 'local.rdf' },
  get CONTENT_PATH  () { return 'chrome://drood/content/' },
  get LOCALE_PATH   () { return 'chrome://drood/locale/' },
  get TRANSFORM_PATH() { return 'chrome://drood/content/xsl/' },
  get SCHEMA_URL    () { return 'chrome://drood/content/schema.rdf' },
  get DOCTYPES_URL  () { return 'chrome://drood/content/doctypes.rdf' },
  get DIR_PERMS     () { return 0755 },
  get PROJECTS_URL  () { return 'http://drood.com/project' },
  get LOCAL_PROJECTS() { return 'http://drood.com/local-projects' },
  get DOCUMENTS_URL () { return "http://drood.com/res/" },
  get SCENE_PREFIX  () { return "http://drood.com/scene/" },
  ...
  get BUG_REPORT_URL   () { return 'http://www.drood.com/bugreport' },
  get SUPPORT_URL      () { return 'http://www.drood.com/splash/support' },
  get WALKTHRU_URL     () { return 'http://www.drood.com/walkthru' },
  get USER_GUIDE_URL   () { return 'http://wiki.drood.com/' },
  get FORUMS_URL       () { return 'http://forums.drood.com/' },
  get PROJ_CENTRAL_URL () { return 'http://pc.drood.com/' },

  get PREF_BRANCH    () { return 'drood' },
  ...
  get NS_CX         () { return 'http://drood.com/NS/v1/' },
